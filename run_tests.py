...
"""
Test runner for TRS-80 Color Computer BASIC emulator.
Automatically discovers and runs all test files, providing comprehensive reporting.
"""
...
Examples:
  ...
  python run_tests.py --pattern "test_*math*.py"  # Run specific pattern
    ...
    print("TRS-80 Color Computer BASIC Emulator Test Runner")
    print("=" * 60)
