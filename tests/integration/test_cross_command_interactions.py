...
class CrossCommandInteractionTest(BaseTestCase):
    ...
    def test_inkey_with_program_vs_immediate_mode(self):
        ...
        # Set up key buffer
        self.basic.key_buffer = ['X', 'Y']
        
        # Immediate mode should consume key
        ...
        # Program mode should also consume key
    ...
    def test_array_access_in_different_contexts(self):
        ...
        # In IF statement
        result = self.basic.execute_command('IF A(2) = 20 THEN PRINT "CORRECT"')
        text = self.get_text_output(result)
