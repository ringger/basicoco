"""
Tests for Rubik's cube solver — Step 1: Bottom Cross.

Scrambles the cube with known move sequences, runs the solver,
and verifies the bottom cross is correctly solved.
"""
...
def _build_solver_test(scramble_moves, max_frames=50000):
...
def _run_solver_test(basic, helpers, scramble_moves, max_frames=50000):
